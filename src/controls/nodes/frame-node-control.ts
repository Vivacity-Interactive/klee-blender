...
export class FrameNodeControl extends NodeControl implements DrawableControl {
    ...
    private applyCommentColor(nodeColor: string) {
        if (nodeColor == undefined || nodeColor == '')
            nodeColor = FrameNodeControl._DEFAULT_COMMENT_COLOR;
    ...
    private drawTitle(canvas: Canvas2D) {
        ...
        canvas.fillStyle(this.headerBackgroundColor)
            ...
            .fillStyle(FrameNodeControl._HEADER_TEXT_COLOR)
