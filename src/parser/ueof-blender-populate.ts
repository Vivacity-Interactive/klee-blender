        ...
        "Object": {
            ...
            [EUEOFToken.CUSTOM]: {
                "Pin": {
                    ...
                    // "PinType.PinCategory": (parser: UEOFValueParser, pin: PinProperty) => {},
                    // "PinType.PinSubCategory": (parser: UEOFValueParser, pin: PinProperty) => {},
                    // "PinType.PinCategoryObject": (parser: UEOFValueParser, pin: PinProperty) => {},
                    // "PinType.PinSubCategoryObject": (parser: UEOFValueParser, pin: PinProperty) => {},
